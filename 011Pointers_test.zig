...
test "Первый указатель ..." {
    ...
    //Указатель - число
    //Это число можно изменять, также это не совсем простое число
    //Это число - виртуальный адрес в памяти
    //Виртуальный - и точка не думай о; эттом тебе оно покачто не надо
    //Но, естт операция "разименованиею
    //С её помощью можно изменять или брать значение содержащиеся по указателю
...
//Хочу заметить что любой константный указатель начинается с
// *const
// тоесть *const T
//Константный указатель - может константой и не быть
//Он УКАЗЫВАЕТ НА КОНСТАНТУ
